...
const ModalActionButton: FunctionComponent<Props> = ({
  ...
  return (
    <button
      ...
      type={type}
      className={clsx(
        "flex justify-center rounded px-12.5 py-3  text-center font-medium transition disabled:bg-graydark disabled:dark:bg-whiter disabled:dark:text-slate-800  disabled:cursor-not-allowed",
        {
          ...
          "bg-c_gray text-slate-800  hover:bg-meta-1 hover:text-white": actionType === "CANCEL",
          "bg-gray-2 text-slate-800  hover:bg-meta-1 hover:text-white": actionType === "CANCEL-2",
        },
        className
      )}
    >
