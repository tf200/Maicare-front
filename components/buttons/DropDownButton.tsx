            ...
            {items.map((item) => (
              <li>
                <button
                  ...
                  className={cn("px-4 py-2 hover:bg-gray disabled:hover:bg-white disabled:opacity-60 cursor-pointer dark:hover:bg-gray-600 dark:hover:text-white w-full  text-left")}
