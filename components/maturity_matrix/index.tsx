...
export default function MaturityMatrixTable({
  ...
  return (
    <table className="table-fixed w-full">
      <thead>
        <tr>
          <th className="border border-stroke bg-yellow-400 text-c_black text-lg">Domein</th>
      ...
      <tbody>
        {domains.map((domain, index) => (
          <tr key={domain.name}>
            <td className="w-1/8 align-top border border-stroke p-2 font-bold bg-yellow-400 text-c_black text-lg">
              {domain.name}
            </td>
  ...
  return (
    <div
      className={cn(
        ...
        selected &&
          "border-2 rounded-md bg-purple-100 border-purple-500 text-c_black cursor-default",
