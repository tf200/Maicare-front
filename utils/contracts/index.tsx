...
async function createContractWorkingHours(
  contractId: number,
  workingHours: AddWorkingHoursReqDto
) {
...
export const useCreateContractWorkingHours = (contractId: number) => {
  ...
  return useMutation({
    mutationFn: (data: AddWorkingHoursReqDto) =>
      createContractWorkingHours(contractId, data),
    onSuccess: () => {
...
async function getContractWorkingHours(
  contractId: number,
