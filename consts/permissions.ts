...
> = {
  ADMIN: [...PERMISSIONS],
  BEHAVIORAL_SPECIALIST: [CLIENT_VIEW, CLIENT_EDIT, EMPLOYEE_VIEW, EMPLOYEE_EDIT, CONVERSATION_VIEW, DASHBOARD_VIEW],
  MANAGEMENT: [CLIENT_VIEW, CLIENT_EDIT, EMPLOYEE_VIEW, EMPLOYEE_EDIT, CONVERSATION_VIEW, DASHBOARD_VIEW],
  ...
  BACK_OFFICE: [CLIENT_VIEW, CLIENT_EDIT, CLIENT_CREATE, EMPLOYEE_VIEW, EMPLOYEE_EDIT, EMPLOYEE_CREATE, CONVERSATION_VIEW, DASHBOARD_VIEW],
  ADMINISTRATIVE_ASSISTANT: [CLIENT_VIEW, CLIENT_EDIT, CLIENT_CREATE, EMPLOYEE_VIEW, EMPLOYEE_EDIT, EMPLOYEE_CREATE, CONVERSATION_VIEW, DASHBOARD_VIEW],
  Default: []
};
